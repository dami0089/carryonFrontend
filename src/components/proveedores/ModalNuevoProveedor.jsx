...
const ModalNuevoProveedor = () => {
  ...
  const { consultarCuit, cuitObtenido } = useClientes();
  ...
  const consultarBase = async (cuit) => {
    try {
      ...
      await guardarProveedor({
        ...
        provincia: provinciaProveedor,
        email: emailProveedor,
      });

      setConsultarListadoProveedores(true);
    } catch (error) {
  ...
  useEffect(() => {
    if (actualizarAtributos) {
      if (cuitObtenido.errorGetData) {
        ...
        setNombreProveedor(cuitObtenido.nombre);
        setDomicilioProveedor(cuitObtenido.domicilioFiscal.direccion);
        setProvinciaProveedor(cuitObtenido.domicilioFiscal.nombreProvincia);
        if (cuitObtenido.domicilioFiscal.localidad != null) {
          setLocalidadProveedor(cuitObtenido.domicilioFiscal.localidad);
        }
        setTipoProveedor("A");
      }
                  ...
                  <form className="my-2 mx-2" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-1">
                      ...
                      <input
                        ...
                        onChange={(e) => setLocalidadProveedor(e.target.value)}
                      />
                    </div>
                    <div className="mb-1">
                      <label
                      ...
                      <input
                        ...
                        onChange={(e) => setProvinciaProveedor(e.target.value)}
                      />
                    </div>
                    <div className="mb-1">
                      <label
