...
const ModalEditarSemi = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await editarSemi(idEditarSemi, modeloSemi, patenteSemi, yearSemi);
    setIdEditarSemi("");
    setModeloSemi("");
    setPatenteSemi("");
    setYearSemi("");
  ...
  return (
    <Transition.Root show={modalEditarSemi} as={Fragment}>
      <Dialog
        as="div"
        className="fixed inset-0 z-50 overflow-y-auto"
        onClose={handleModalEditarSemi}
      >
...
export default ModalEditarSemi;
