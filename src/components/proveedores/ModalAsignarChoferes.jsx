...
const ModalAsignarChoferes = () => {
  ...
  const { handleModalAsignarChoferes, modalAsignarChoferes } = useServicios();
  ...
  return (
    <Transition.Root show={modalAsignarChoferes} as={Fragment}>
      <Dialog
        as="div"
        className="fixed inset-0 z-50 overflow-y-auto"
        onClose={handleModalAsignarChoferes}
      >
            ...
            <div className="inline-block transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 sm:align-middle">
              <div className="absolute top-0 right-0 hidden pt-4 pr-4 sm:block">
                <button
                  ...
                  onClick={handleModalAsignarChoferes}
                >
                  ...
                  <form className="my-2 mx-2" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-1">
                      ...
                      <input
                        ...
                        onChange={(e) => setApellidoChofer(e.target.value)}
                      />
                    </div>
                    <div className="mb-1">
                      <label
                    ...
                    {camionesProveedor.length != 0 ? (
                      <select
                        id="cliente"
                        className="mt-2 w-full rounded-md border-2 p-2 placeholder-gray-400"
                        value={idCamionChofer}
                        onChange={(e) => setIdCamionChofer(e.target.value)}
                      >
...
export default ModalAsignarChoferes;
