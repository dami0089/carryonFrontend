...
const ModalNuevoSemi = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await nuevoSemi(cuitEditarProveedor, modeloSemi, patenteSemi, yearSemi);
  };

  return (
    <Transition.Root show={modalNuevoSemi} as={Fragment}>
      <Dialog
        as="div"
        className="fixed inset-0 z-50 overflow-y-auto"
        onClose={handleModalNuevoSemi}
      >
                  ...
                  <form className="my-2 mx-2" onSubmit={handleSubmit}>
                    <div className="mb-1">
                      ...
                      <input
                        ...
                        value={modeloSemi}
                        onChange={(e) => setModeloSemi(e.target.value)}
                      />
                    </div>
                    ...
                    <div className="mb-1">
                      ...
                      <input
                        ...
                        value={yearSemi}
                        onChange={(e) => setYearSemi(e.target.value)}
                      />
                    </div>
