...
const ListadoContable = () => {
  const { setCuitEditarProveedor, setSeleccionProveedor, serviciosProveedor } =
    useProveedores();
    ...
    <>
      <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
        <table className="w-full min-w-[640px] table-auto">
          <thead>
            <tr>
              {["Fecha", "Hora", "Origen", "Destino", "Estado", "Accion"].map(
                (el) => (
                  <th
                    key={el}
...
export default ListadoContable;
