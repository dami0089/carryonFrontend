...
const ListadoOperacionesCoordinadasDiasAnteriores = () => {
  ...
  useEffect(() => {
    const obtenerServ = async () => {
      if (selectInicio == 2 && actualizoListadosDespuesDeAsignar) {
        handleCargando();
        await obtenerServicios();
  ...
  useEffect(() => {
    const obtenerServ = async () => {
      if (selectInicio == 3 && actualizoListadosDespuesDeAsignar) {
        handleCargando();
        await obtenerServiciosHoy();
        setActualizoListadosDespuesDeAsignar(false);
        handleCargando();
  ...
  return (
    <>
      <div className="mt-10">
        ...
        <div className="mb-5 ml-3 mr-3 flex justify-between">
          <Typography className="font-bold uppercase">
            Coordinados dias Anteriores
          </Typography>
          {/* <Button
            className="w-30 mx-2 mb-5 bg-green-300 text-center"
            fullWidth
            ...
            <CardBody className=" overflow-x-scroll px-0 pb-2 pt-0">
              <div className="max-h-[78vh] overflow-y-auto">
                <table className="w-full min-w-[640px] table-auto">
                  ...
                  <tbody>
                    {serviciosSinCerrar // Filtrar proveedores con estado distinto a "Terminado"
                      .map(
                        (
                          {
                            _id,
...
export default ListadoOperacionesCoordinadasDiasAnteriores;
