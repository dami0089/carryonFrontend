...
const ListadoOperacionesCoordinadasProximosDias = () => {
      ...
      <div className="mt-10">
        ...
        <div className="mb-10 ml-3 mr-3 flex justify-between">
          <Typography className="font-bold uppercase">
            Coordinados para proximos dias
          </Typography>
        </div>
            ...
            <CardBody className=" overflow-x-scroll px-0 pb-2 pt-0">
              <div className="max-h-[78vh] overflow-y-auto">
                <table className="w-full min-w-[640px] table-auto">
                  ...
                  <tbody>
                    {serviciosManana // Filtrar proveedores con estado distinto a "Terminado"
                      .map(
                        (
                          {
                            _id,
...
export default ListadoOperacionesCoordinadasProximosDias;
