...
const ModalNuevoDomicilio = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if ([domicilioEntrega, localidadEntre, provinciaEntrega].includes("")) {
    ...
    setRecargoDomis(true);

    if (cierroModalDomis) {
      handleModalDomicilio(), handleModalNuevoServicio3();
      setDomicilioEntrega("");
      setLocalidadEntre("");
      setProvinciaEntrega("");
      setDomiFantasia("");
      setActualizoListadoDOmis(true);
      setCierroModalDomis(false);
    } else {
      handleModalDomicilio();
      setDomiFantasia("");
      setDomicilioEntrega("");
  ...
  return (
    <Transition.Root show={modalDomicilio} as={Fragment}>
      <Dialog
        as="div"
        className="fixed inset-0 z-50 overflow-y-auto"
        onClose={handleModalDomicilio}
      >
                  ...
                  <form className="my-2 mx-2" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-1">
                      ...
                      <input
                        ...
                        className="mt-2 w-full rounded-md border-2 p-2 placeholder-gray-400"
                        value={localidadEntre}
                        onChange={(e) => setLocalidadEntre(e.target.value)}
                      />
                    </div>
                    <div className="mb-1">
                      <label
...
export default ModalNuevoDomicilio;
