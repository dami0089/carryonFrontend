...
const ModalEstadoDocumentacion = () => {
  const {
  ...
  return (
    <Transition.Root show={modalCambiarEstadoDocumentacion} as={Fragment}>
      <Dialog
        as="div"
        className="fixed inset-0 z-50 overflow-y-auto"
        onClose={handleCambiarEstado}
      >
...
export default ModalEstadoDocumentacion;
