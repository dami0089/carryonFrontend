...
const ModalNuevoServicio = () => {
  ...
  return (
    <Transition.Root show={modalNuevoServicio} as={Fragment}>
      <Dialog
        as="div"
        className="fixed inset-0 z-50 overflow-y-auto"
        onClose={handleModalNuevoServicio}
      >
                  ...
                  <form className="my-2 mx-2" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-1">
                      ...
                      >
                        ...
                        <option key={5} value={"vacios"}>
                          Devolucion Vacios
                        </option>
                        <option key={5} value={"empty-pick"}>
                          Empty Pick Up
                        </option>
                      </select>
                    </div>
