...
const ModalAgregarCampo = () => {
  ...
  return (
    <Transition.Root show={modalAgragarCampo} as={Fragment}>
      <Dialog
        as="div"
        className="fixed inset-0 z-50 overflow-y-auto"
        onClose={handleModalAgregarCampo}
      >
            ...
            <div className="inline-block transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 sm:align-middle">
              <div className="absolute top-0 right-0 hidden pt-4 pr-4 sm:block">
                <button
                  ...
                  onClick={handleModalAgregarCampo}
                >
                  ...
                  <form className="my-2 mx-2" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-1">
                      ...
                      <textarea
                        ...
                        value={descripcionAgregarFactura}
                        onChange={(e) =>
                          setDescripcionAgregarFactura(e.target.value)
                        }
                        autocomplete="off"
                      />
                    </div>
                    ...
                    <div className="mb-1">
                      ...
                      <input
                        ...
                        placeholder="Precio"
                        className="mt-2 w-full rounded-md border-2 p-2 placeholder-gray-400"
                        value={precioAgregarFactura}
                        onChange={(e) =>
                          setPrecioAgregarFactura(e.target.value)
                        }
                        autocomplete="off"
                      />
                    </div>
