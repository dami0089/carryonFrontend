...
const ModalAgregarObservaciones = () => {
  const {
    cuitEditar,
    domicilioEntrega,
    setDomicilioEntrega,
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    console.log(observacionesObtenerServicio);
    handleCargando();
    await actualizarObsServicio(
      idObtenerServicio,
      observacionesObtenerServicio
    );
    handleModalAgregarObservaciones();
  ...
  return (
    <Transition.Root show={modalAgregarObservaciones} as={Fragment}>
      <Dialog
        as="div"
        className="fixed inset-0 z-50 overflow-y-auto"
        onClose={handleModalAgregarObservaciones}
      >
            ...
            <div className="inline-block transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 sm:align-middle">
              <div className="absolute top-0 right-0 hidden pt-4 pr-4 sm:block">
                <button
                  ...
                  onClick={handleModalAgregarObservaciones}
                >
                  ...
                  <form className="my-2 mx-2" onSubmit={handleSubmit}>
                    <div className="mb-1">
                      ...
                      <textarea
                        ...
                        value={observacionesObtenerServicio}
                        onChange={(e) =>
                          setObservacionesObtenerServicio(e.target.value)
                        }
                      />
                    </div>
...
export default ModalAgregarObservaciones;
