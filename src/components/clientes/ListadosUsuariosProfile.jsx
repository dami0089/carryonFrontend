...
const ListadosUsuariosProfile = () => {
  ...
  useEffect(() => {
    const traerData = async () => {
      await obtenerUsuariosPorEmpresa(cuitEditar);
    };
    traerData();
  }, []);
  ...
  useEffect(() => {
    const traerData = async () => {
      if (actualizarListadoUsuario) {
        await obtenerUsuariosPorEmpresa(cuitEditar);
        setActualizarListadoUsuario(false);
      }
    };
    traerData();
  }, [actualizarListadoUsuario]);
...
export default ListadosUsuariosProfile;
