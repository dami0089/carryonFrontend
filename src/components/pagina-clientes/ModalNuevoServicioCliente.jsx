...
const NuevoServicioCliente = () => {
  ...
  useEffect(() => {
    setIdClienteServicio(auth.cliente);
  }, []);
  ...
  return (
    <Transition.Root show={newService} as={Fragment}>
      <Dialog
        as="div"
        className="fixed inset-0 z-50 overflow-y-auto"
        onClose={handleNewService}
      >
...
export default NuevoServicioCliente;
