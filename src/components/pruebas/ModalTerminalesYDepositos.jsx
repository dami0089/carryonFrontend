...
const ModalTerminalesYDepositos = () => {
  const {
  ...
  return (
    <Transition.Root show={modalTerminales} as={Fragment}>
      <Dialog
        as="div"
        className="fixed inset-0 z-50 overflow-y-auto"
        onClose={handleModalTerminales}
      >
            ...
            <div className="inline-block transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 sm:align-middle">
              ...
              <div className="sm:flex sm:items-start">
                <div className="mt-3 w-full text-center sm:mt-0 sm:ml-0 sm:text-left">
                  ...
                  >
                    Nueva Terminal / Deposito Fiscal
                  </Dialog.Title>
...
export default ModalTerminalesYDepositos;
